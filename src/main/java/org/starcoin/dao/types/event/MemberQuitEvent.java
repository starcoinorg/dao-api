...
public final class MemberQuitEvent {
    ...
    public MemberQuitEvent(@com.novi.serde.Unsigned Long dao_id, @com.novi.serde.Unsigned Long member_id, AccountAddress address, java.math.@com.novi.serde.Unsigned @com.novi.serde.Int128 BigInteger sbt) {
    ...
    public static MemberQuitEvent deserialize(com.novi.serde.Deserializer deserializer) throws com.novi.serde.DeserializationError {
    ...
    public static MemberQuitEvent bcsDeserialize(byte[] input) throws com.novi.serde.DeserializationError {
        if (input == null) {
             throw new com.novi.serde.DeserializationError("Cannot deserialize null array");
        }
        com.novi.serde.Deserializer deserializer = new com.novi.bcs.BcsDeserializer(input);
        MemberQuitEvent value = deserialize(deserializer);
    ...
    public boolean equals(Object obj) {
        ...
        MemberQuitEvent other = (MemberQuitEvent) obj;
    ...
    public static final class Builder {
        ...
        public MemberQuitEvent build() {
            return new MemberQuitEvent(
                dao_id,
                member_id,
                address,
                sbt
