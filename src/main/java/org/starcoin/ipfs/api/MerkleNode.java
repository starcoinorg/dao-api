...
public class MerkleNode {
    ...
    public static MerkleNode fromJSONObject(Object rawjson) {
        ...
        List<MerkleNode> links = linksRaw == null ?
                ...
                linksRaw.stream().map(x -> MerkleNode.fromJSONObject(x)).collect(Collectors.toList());
...
//        return getObjectMapper().writeValueAsString(this.toJSONObject());
//    }
