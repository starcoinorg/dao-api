...
final class TraitHelpers {
    ...
    static void serialize_option_ScriptFunction(java.util.Optional<ScriptFunction> value, com.novi.serde.Serializer serializer) throws com.novi.serde.SerializationError {
        if (value.isPresent()) {
            serializer.serialize_option_tag(true);
            value.get().serialize(serializer);
        } else {
    ...
    static java.util.Optional<ScriptFunction> deserialize_option_ScriptFunction(com.novi.serde.Deserializer deserializer) throws com.novi.serde.DeserializationError {
        boolean tag = deserializer.deserialize_option_tag();
        if (!tag) {
            return java.util.Optional.empty();
        } else {
            return java.util.Optional.of(ScriptFunction.deserialize(deserializer));
        }
    }
